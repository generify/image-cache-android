...
public class ImageFetcher extends ImageResizer {
     ...
     * @param imageHeight
     */
    public ImageFetcher(Context contenxt, int imageWidth, int imageHeight) {
        super(contenxt, imageWidth, imageHeight);
        init(contenxt);
    }
    ...
    public boolean downloadUrlToStream(String urlString, OutputStream outputStream) {
        ...
        try {
            ...
            Log.d(TAG, "readTimeout: " + urlConnection.getReadTimeout());
            ...
            try {
                ...
                Log.e(TAG, "Error in closing in and out streams - " + e);
            }
        }
        return false;
    }
